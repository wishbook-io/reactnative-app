...
class Autocomplete extends Component {
    static propTypes = {
         ...
         * commenting it for now due to deprecation warning
         */
    ...
    static defaultProps = {
        ...
        renderTextInput: props => <TextInput {...props} underlineColorAndroid="transparent" multiline={false} />,
        ...
        return (
            <View style={[styles.container, containerStyle]}>
                <View style={[styles.inputContainer, inputContainerStyle]}>
                    ...
                    <View style={[{ height: 1, backgroundColor: colorresource.Darkgrayishblue }]} />
                </View>
                {!hideResults && (
                    <View
