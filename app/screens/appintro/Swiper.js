...
const styles = {
  ...
  buttonText: {
    fontSize: 50,
    color: colorresource.drakskyblue
  },
...
export default class Swiper extends Component {
  ...
  static propTypes = {
    ...
    navigateButtonColor: PropTypes.string,
    navigateButtonText: PropTypes.string,
    navigationButtonOnPress: PropTypes.func,
    navigateButtonVisible: PropTypes.bool,
    /**
  ...
  static defaultProps = {
    ...
    index: 0,
    navigateButtonColor: colorresource.white,
    onIndexChanged: () => null,
    navigationButtonOnPress: () => { },
  ...
  renderButton = () => {
    return this.props.navigateButtonVisible ?
      (<View pointerEvents="box-none" style={[styles.buttonNavigateWrapper, styles.fullScreen]}>
        {<Button text={this.props.navigateButtonText} buttonColor={this.props.navigateButtonColor} onPress={this.props.navigationButtonOnPress} {...this.props.buttonTestId}/>}
      </View>)
      : (<View />)
  }
